...
checkedgecases(void)
{
	...
	hebi_zsetstr(a, "0xFFAB15239CA381E3F1412D3301419807981490AB124908DE12490876BC912903", NULL, 0, 0);
	hebi_zsetstr(b, "0x859486D4F84517298D4BD5C9EF209C88AA517F5561E6F9B5538798AB4EB8B779", NULL, 0, 0);
	assert(hebi_zbits(a) == 256 && hebi_zbits(b) == 256);
	hebi_zdivrem(q, r, a, b);
	zcheckbc(q, "%Z / %Z", a, b);
	zcheckbc(r, "%Z %% %Z", a, b);

	hebi_zsetstr(a, "0xFE22F94210D832EAD173882718DEBF5F5C365EF6695D61298D0287B79146EA9B", NULL, 0, 0);
	hebi_zsetstr(b, "0xFE22F94210D832EA7C869F37B225842AC624237A01FCB84306E6E0B831A093EA", NULL, 0, 0);
	assert(hebi_zbits(a) == 256 && hebi_zbits(b) == 256);
	hebi_zdivrem(q, r, a, b);
	zcheckbc(q, "%Z / %Z", a, b);
	zcheckbc(r, "%Z %% %Z", a, b);

	hebi_zsetstr(a, "0xE09767DE6F2603B55C539A4C6A95CA413D0ACB69BF3179EE7026C52C587388E16B204988BDAA297B818D08B4C56130E4", NULL, 0, 0);
	hebi_zsetstr(b, "0xE09767DE6F2603B55C539A4C6A95CA413D0ACB69BF3179EE7026C52C587388E1", NULL, 0, 0);
